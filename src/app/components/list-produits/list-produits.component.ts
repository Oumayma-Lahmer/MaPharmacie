...
passerCommande() {
  this.produitIds = this.products.map(product => product.id);
  this.commandeService.uploadOrdonnance(this.selectedFile, this.clientId, this.produitIds).subscribe(response => {
